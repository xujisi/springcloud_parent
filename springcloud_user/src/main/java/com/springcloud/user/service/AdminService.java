...
import com.springcloud.user.dao.AdminDao;
...
public class AdminService {
    ...
    public Admin login(Admin admin) {
        ...
        //先根据用户名查询对象
        Admin adminFind = adminDao.findByLoginname(admin.getLoginname());
        //然后拿数据库的密码和输入的密码匹配
        if (adminFind != null && encoder.matches(admin.getPassword(), adminFind.getPassword())) {
            //登录成功
            return adminFind;
        }
        return null;
